...
<head>
    ...
    <link rel="stylesheet" href="/FoxPath-Project/Site_em_si/SCRIPTS/CSS/style_idioma.css">
    <title>FOXPATH - Idioma</title>
</head>
<header>
...
<body class="body_idioma">
    <div class="idioma">
        <div class="ingles">
            <button onclick="btn_go_to_niveis()" class="btn_ingles"></button>
        </div>
    </div>
</body>
