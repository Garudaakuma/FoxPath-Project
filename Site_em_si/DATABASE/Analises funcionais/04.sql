-- ! Quantidade de alternativas erradas em um grupo de perguntas no idioma
SELECT
	i.nome,
    gq.nome,
    COUNT(a.id_alternativa) AS total_alternativas_falsas
FROM alternativas a
...
ORDER BY i.nome, total_alternativas_falsas DESC;